...
<nav class="navbar navbar-default navbar-fixed-top navbar-inverse" style="box-shadow: 0px 3px 4px rgba(225, 225, 225, .6); background-color: #2E4059; font-family: 'Sora', sans-serif;">
 ...
 elseif(!isset($_SESSION['login_employer']) && !isset($_SESSION['login_user']))
  ...
  Sign In 
        ...
        <li> <a href = "mailto: sumedh.patil@somaiya.edu" style="color:black;">  Contact Us. </a></li>
      </ul>
