...
<!-- Main Container -->
<div class="container-fluid" style=" background-color: #2E4059; background-position: center; background-size: cover; background-repeat: no-repeat; background-attachment: fixed;">
    ...
    <div class="hero" style=" color:whitesmoke; height: 1700px;">
      ...
      <!--	images in home page-->
            <div class="floating-area">
                <img class="floating" src="img/69.jpg" width="42%" style="padding-top:90px; padding-left: 50px; padding-bottom:100px; float: left;"/>
            </div>
             ...
             <!-- Texts in home page with heading and sub texts-->
                  <div class="animated slideInRight">
                   <h1 style="padding-top:250px; padding-right:290px; font-size: 30px; float: right;">
                       <strong style="font-family: 'Schoolbell', cursive; font-family: 'Vollkorn', serif;">A good life begins with a good COMPANY!</strong>
                   </h1>
                   ...
                   <!-- <br> Find the job meant for you. <b style="color: #e9c46a">#jobvioit</b> -->
                         ...
                         <button type="button" class="btn" style="width:120px; height:40px;  background-color:#e9c46a; border-radius: 0 !important;"> 
                             <a href = "mailto: sumedh.patil@somaiya.edu" style="color:black;">  Get in Touch. </a>
                         </button>
                         </div>
            ...
            <div style="width: 100%;" class="row" >
		           <div class="col-md-9"  >
                    <div style=" margin-top: 30px; padding-left: 50px;">
                        ...
                        <input style="color:#000; height:45px; width:800px; border-radius:30px 0px 0px 30px;" type="text" placeholder="     Search " name="q">
                        <button type="submit" style="height:45px; width:160px; border-radius:0px 30px 30px 0px; background-color: #257059; "><i class="fa fa-search bb"></i></button>
                            ...
                            <!----------------------SUM OF POSTS & ACTIVE USERS USING VIEW TABLES--------------------------->
                                        ...
                                        <h3 style="font-family: 'Schoolbell', cursive; font-family: 'Vollkorn', serif; color: #f2cc8f; padding-left:4px;"> <h3 style="font-family: 'Schoolbell', cursive; font-family: 'Vollkorn', serif; color: #f2cc8f; padding-left:4px;"> Total Job Posts Available: <?php echo $numberofposts; ?> </h3>
                            ...
                            <div class="row">
                            <div class="jumbotron" style="width: 45rem; margin: 20px; background-color:#50479A; padding: 20px; height: 350px;">
  <h1 class="display-4" style="color: #50479A; margin-right: 20rem;">Upgrade, to pro!</h1>
  <hr class="my-4">
                               ...
                               while(  $row=$result->fetch_assoc())
                                {
                                 ...
                                 $status=$row['status'];
                             ?>   
                                <div class="col-md-4 crd" style="margin: 20px; background-color:#50479A; padding: 20px; height: 350px;">
